...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        Document doc = usersCollection.find().filter(new Document("username",username)).first();
        if(doc == null){
             user = new Document("_id",username);
        ...
        if (email != null && !email.equals("")) {
            ...
            //Document emaill = new Document("email", email);
    ...
    public Document validateLogin(String username, String password) {
        ...
        user = usersCollection.find().filter(new Document("_id",username)).first();
